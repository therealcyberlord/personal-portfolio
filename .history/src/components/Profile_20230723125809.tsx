      ...
      <figure className="flex">
        <div className="pt-6 text-center space-y-4">
          <blockquote>
            ...
            <p className="p-5 text-lg text-white text-xl">{description}</p>
          </blockquote>
        </div>
      </figure>
      <figcaption className="font-medium text-center my-3">
        <p className="text-sky-500 dark:text-sky-400 font-large">{name}</p>
        <p className="text-sky-500 dark:text-sky-400 font-large">{role}</p>
      </figcaption>
    </>
  );
};
