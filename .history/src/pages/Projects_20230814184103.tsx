    ...
    <div className="px-4 py-4">
      ...
      <div className="grid gap-8" style={{ gridAutoFlow: "column" }}>
        ...
        <Project
          ...
          description="Blijax is a multipurpose AI-powered web application whose purpose is targeted at providing financial advice. It is powered by GPT 4 behind the scene"
