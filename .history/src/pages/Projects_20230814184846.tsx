    ...
    <div className="px-4 py-4">
      ...
      <div className="grid gap-8" style={{ gridAutoFlow: "column" }}>
        ...
        <Project
          ...
          description="A data science project aimed at exploring the impact of COVID-19 through the lens of exploratory data analysis. Currently the most upvoted health code publication on Kaggle, totaling over 500K+ views"
