  ...
  return (
    <div className="px-4 py-4">
      ...
      <div className="grid gap-8" style={{ gridAutoFlow: "column" }}>
        <Project
          name="Hintings AI"
          description="Hintings is an advanced Document Question Answering (QA) system that utilizes cutting-edge large language models (LLM), such as ChatGPT and GPT 4"
